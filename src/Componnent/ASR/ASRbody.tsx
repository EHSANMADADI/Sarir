...
export default function ASRbody() {
  ...
  return (
    <div className="bg-blue-50 max-h-screen h-auto flex font-Byekan items-center justify-around">
      <div className="input-div flex flex-col mt-32">
        <input
          multiple
          id="dropzone-file"
          type="file"
        ...
        <div className="mb-16 flex" dir="rtl">
          ...
          {file &&(<div className="flex items-center mx-2">
            <span className="text-red-700"><MdDeleteSweep/></span>
